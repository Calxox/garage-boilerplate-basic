...
document.addEventListener('click', event => {
  ...
  switch (action) {
    ...
    case 'sample-image': imageSelection++; releaseUpload(); Object.assign(upload, { reading: false, preview: '/prototype/assets/bushfire-screenshot.png', source: 'User upload', file: null, error: '' }); renderUpload(); break;
    case 'upload-back': {
      if (upload.step === 2) {
